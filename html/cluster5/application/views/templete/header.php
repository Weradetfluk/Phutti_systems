...
<head>
  ...
  <title>ระบบรับสมัครชุมนุม</title>
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/latest/css/font-awesome.min.css">
  <!-- Favicon -->
  <link rel="icon" href="<?php echo base_url().'assets/templete/material-kit-master'?>/assets/img/brand/pic.jpg" type="image/png">
  <!-- Fonts -->
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700">
  <!-- Icons -->
  <link rel="stylesheet" href="<?php echo base_url().'assets/templete/material-kit-master'?>/assets/css/material-kit.css" type="text/css">
